...
# %%
GRFE_TIER_DF_1 = GRFE_DF[GRFE_DF['TIER'] == 'Tier 1'] 


# %%
GRFE_TIER_DF_2= GRFE_TIER_DF_1[['RE_EDD_name',
 'TIER']]                     


# %%
GRFE_TIER_DF_2.rename(columns = {'RE_EDD_name':'RETAILER NAME'}, inplace = True)


# %%
GRFE_TIER_DF_2 = GRFE_TIER_DF_2.drop_duplicates(subset='RETAILER NAME', keep="first")
...
# %%
Tier1_retailers = GRFE_TIER_DF_2.append(SIRVAL_TIER_DF_2, ignore_index=True)
